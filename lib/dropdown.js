...
/* harmony default export */ var dropdownvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    addEventListenerToTriggerElm: function addEventListenerToTriggerElm(type, listener) {
    ...
    initEvent: function initEvent() {
      ...
      // 控制自定义元素的样式
      if (!splitButton) {
        this.addEventListenerToTriggerElm('focus', function () {
          _this3.focusing = true;
        });
        this.addEventListenerToTriggerElm('blur', function () {
          _this3.focusing = false;
        });
        this.addEventListenerToTriggerElm('click', function () {
          _this3.focusing = false;
        });
      }
      if (trigger === 'hover') {
