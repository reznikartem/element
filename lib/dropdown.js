...
/* harmony default export */ var dropdownvue_type_script_lang_js = ({
  ...
  beforeDestroy: function beforeDestroy() {
    for (var _iterator = this.eventsForDispose, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
      var _ref;
  ...
  methods: {
    ...
    addEventListenerToElement: function addEventListenerToElement(element, type, listener) {
    ...
    initEvent: function initEvent() {
      ...
      // 控制自定义元素的样式
      if (!splitButton) {
        this.addEventListenerToElement(this.triggerElm, 'focus', function () {
          _this3.focusing = true;
        });
        this.addEventListenerToElement(this.triggerElm, 'blur', function () {
          _this3.focusing = false;
        });
        this.addEventListenerToElement(this.triggerElm, 'click', function () {
          _this3.focusing = false;
        });
      }
      if (trigger === 'hover') {
